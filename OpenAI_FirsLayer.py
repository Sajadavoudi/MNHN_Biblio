...
def process_json_file(input_file, output_file):
    ...
    - output_file: Path to save the processed JSON file with filtered results.
    """
    try:
...
# Example Usage
'''
input_json = "janvier.json"  # Input JSON file with original data
output_json = "first_Layer_janvier.json"  # Output JSON file with filtered results
